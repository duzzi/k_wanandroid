...
//    }
//
//    public MyHttpLoggingInterceptor(String tag, boolean isLogEnable) {
//        this.tag = tag;
...
//
//        try {
//            mRequestUrl = URLDecoder.decode(
//                    request.url().url().toString(), UTF8.name());
//            String requestStartMessage = "--> " + request.method() + ' ' + mRequestUrl + ' ' + protocol;
...
//
//        try {
//            mResponseUrl = URLDecoder.decode(
//                    clone.request().url().url().toString(), UTF8.name());
//            log("<-- " + clone.code() + ' ' + clone.message() + ' ' + mResponseUrl + " (" + tookMs + "ms）");
//            if (logHeaders) {
//                log(" ");
