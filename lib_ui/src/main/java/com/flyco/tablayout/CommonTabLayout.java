...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //create ViewPager
        if (String.valueOf(ViewGroup.LayoutParams.MATCH_PARENT).equalsIgnoreCase(height)) {
        } else if (String.valueOf(ViewGroup.LayoutParams.WRAP_CONTENT).equalsIgnoreCase(height)) {
        } else {
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public boolean setCurrentTab(int currentTab) {
        return setCurrentTab(currentTab, false);
    }

    //setter and getter
    private boolean setCurrentTab(int currentTab, boolean force) {
        if (currentTab == mCurrentTab && !force) {
            return false;
        }
    ...
    public void initTab(int currentTab) {
        if (setCurrentTab(currentTab, true) && mListener != null) {
