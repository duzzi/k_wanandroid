...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void addNewTab(String title) {
        ...
        CharSequence pageTitle = mTitles == null ? "" : mTitles.get(mTabCount);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void scrollToCurrentTab() {
        ...
        View currentChild = mTabsContainer.getChildAt(mCurrentTab);
        if (currentChild == null) {
            return;
        }
        int offset = (int) (mCurrentPositionOffset * currentChild.getWidth());
...
//            Log.v("updateTabSelection", "updateTabSelection: " + i + "  isSelect: " + isSelect);
            if (tab_title != null) {
    ...
    class InnerPagerAdapter extends FragmentStateAdapter {
        ...
        public InnerPagerAdapter(@NonNull FragmentActivity fragmentActivity, ArrayList<Fragment> fragments, String[] titles) {
